...
public abstract class BaseCameraView extends JavaCameraView implements LoaderCallbackInterface, CameraBridgeViewBase.CvCameraViewListener2 {
     ...
     * @return 是否加载成功
     */
    private boolean has_open_ok = false;

    public boolean loadOpenCV(Context context) {
        // 初始化OpenCV
        has_open_ok = OpenCVLoader.initAsync(OpenCVLoader.OPENCV_VERSION_3_2_0, context, this);
        return has_open_ok;
    }

    public boolean get_has_opencv_open_ok(){
        return has_open_ok;
    }
